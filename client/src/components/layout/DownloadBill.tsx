...
const DownloadBill = () => {
    ...
    const handleResetOrders = async () => {
        const confirmationMessage = "WARNING: This will permanently delete ALL orders from the database and reset the Order ID counter back to the start.\n\nThis action cannot be undone.\n\nAre you absolutely sure you want to proceed?";
        ...
        try {
            const response = await axios.delete(`${API_URL}/api/orders/reset`);
            alert(response.data.message); // Show success message from backend
            setOrders([]); // Clear orders from the UI instantly
        } catch (error) {
                                    ...
                                    <div className="flex justify-between items-start pb-4 border-b">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <p className="mt-1 text-gray-500">
                                                <strong>Date:</strong> {new Date(selectedOrder.createdAt).toLocaleDateString("en-GB")}
                                            </p>
                                        </div>
                                    </div>
